...
const Banner = () => {
    return (
        <div className="bg-[url('https://i.ibb.co/xD3Mfhz/Home.jpg')] bg-cover h-auto w-auto">
            <div className="h-[70vh] relative">
                <div className="text-center absolute bottom-[20%] w-full px-20">
                    <form>
                        <div className="relative">
                            <div className="md:p-6 space-y-4">
                                <h2 className="text-4xl lg:text-7xl font-bold text-green-600 shadow-blue-800 drop-shadow-[-1px_4px_5px_rgba(28,60,192,0.6)]">35% OFF</h2>
                                ...
                                <h2 className="bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text text-3xl font-bold text-transparent lg:text-5xl text-[#0B0B0B]">Best Cosmetics and Beauty Brand Shop</h2>
