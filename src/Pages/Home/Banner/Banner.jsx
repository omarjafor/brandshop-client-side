                    ...
                    <form>
                        <div className="relative">
                            <div className="md:p-6 space-y-4">
                                ...
                                <h2 className="text-4xl lg:text-7xl pb-3 font-bold text-blue-600 drop-shadow-[-1px_4px_5px_rgba(17,131,6,0.6)] bg-gradient-to-br from-green-300 via-blue-500 to-purple-600 bg-clip-text text-transparent">Bombshell Beauty</h2>
