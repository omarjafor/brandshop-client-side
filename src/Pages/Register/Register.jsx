...
const Register = () => {
    ...
    return (
        <div className="flex flex-col-reverse lg:flex-row justify-center gap-10 my-14 items-center">
            <Helmet>
                <title>Bombshell Beauty | Register</title>
            </Helmet>
            <RegLogo></RegLogo>
                ...
                <form onSubmit={handleRegister} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
                    ...
                    <div className="inline-flex items-center">
                        ...
                        >
                            <input
                                type="checkbox"
                                className="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-md border border-blue-gray-200 transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:border-blue-500 checked:bg-cyan-500 checked:before:bg-pink-500 hover:before:opacity-10"
                                name="checkbox"
                            />
                    ...
                    <button
                        className="mt-6 block w-full select-none rounded-lg bg-gradient-to-br from-blue-500 to-cyan-500 hover:bg-gradient-to-tl py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                        type="submit"
                    ...
                    <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
                        ...
                        <Link to='/login'
                            className="font-medium text-blue-500 transition-colors hover:text-green-700"
                            href="#"
                        >
                            &nbsp;  Sign In
                        </Link>
