...
const Login = () => {
    ...
    const handleForgetPassword = () => {
        ...
        if (!email) {
            ...
            setEmailError('Write a valid email address');
        }
    ...
    return (
        <div className="flex flex-col-reverse lg:flex-row justify-center gap-10 my-10 items-center">
            <Helmet>
                <title>Bombshell Beauty | Login</title>
            </Helmet>
            <LoginLogo></LoginLogo>
            <div className="relative flex w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                <div className="relative mx-4 -mt-6 mb-4 grid h-28 place-items-center overflow-hidden rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 hover:bg-gradient-to-tl bg-clip-border text-white shadow-lg shadow-pink-500/40">
                    ...
                    <div className="flex flex-col gap-4 p-6">
                        <div className="relative h-11 w-full min-w-[200px]">
                            <input
                                ...
                                placeholder=" " name="email" type="email" ref={emailRef} required
                            />
                        ...
                        <div className="relative h-11 w-full min-w-[200px]">
                            <input
                                className="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                                placeholder=" " name="password" type={showPass ? "text" : "password"} required
                            />
                ...
                <button
                    className="block w-11/12 mx-auto select-none relative -mt-6 mb-4 place-items-center overflow-hidden rounded-lg bg-gradient-to-br from-green-500 to-lime-500 hover:bg-gradient-to-tl py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
